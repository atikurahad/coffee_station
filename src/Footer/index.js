...
const Foot = () => {
  return (
    <>
      <footer className="text-center bg-gray-900 text-white mt-4">
          ...
          <div className="grid lg:grid-cols-4 md:grid-cols-2">
            <div className="mb-6">
              ...
              <ul className="list-none mb-0">
                <li>
                  <a href="#!" className="text-[yellow] text-2xl">
                    Branding
                  </a>
                </li>
                <li>
            ...
            <div className="mb-6">
              <h5 className="uppercase font-bold mb-2.5 text-3xl">Company</h5>
            ...
            <div className="mb-6">
              <h5 className="uppercase font-bold mb-2.5 text-3xl">
                Conditions
              </h5>
            ...
            <div className="mb-6">
              ...
              <ul className="list-none mb-0">
                <li>
                  <a href="#!" className="text-[tomato] text-2xl">
                    MONDAY ---------- Closed
                  </a>
                </li>
                <li>
                  <a href="#!" className="text-[#bf9d77] text-2xl">
                    TUESDAY ---------- 9:00 - 22:00
                  </a>
                </li>
                <li>
        ...
        <div className="text-center p-4 m-2 text-3xl ">
          © 2022{" "}
